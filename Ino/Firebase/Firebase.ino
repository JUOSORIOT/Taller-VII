...
#define DATABASE_URL "//krunch-abf73-default-rtdb.firebaseio.com/" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
...
void loop()
{
  ...
  // Firebase.ready() should be called repeatedly to handle authentication tasks.
    Firebase.setInt(fbdo,F("/"), 4);
    delay(2000);
    Serial.printf("Get int... %s\n", Firebase.getInt(fbdo, F("/")) ? String(fbdo.to<int>()).c_str() : fbdo.errorReason().c_str());
    delay(2000);
